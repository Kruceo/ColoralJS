...
export function normal(content) {
...
export function subline(content) {
    return _subline + content + _normal;
};
export function doubleline(content) {
    return _doubleline + content + _normal;
};
export function innerline(content) {
    return _innerline + content + _normal;
};


export function lightgrey(content) {
    return _lightgrey + content + _normal;
};
export function lightred(content) {
    return _lightred + content + _normal;
};
export function lightgreen(content) {
    return _lightgreen + content + _normal;
};
export function lightyellow(content) {
    return _lightyellow + content + _normal;
};
export function lightocean(content) {
    return _lightocean + content + _normal;
};
export function lightpurple(content) {
    return _lightpurple + content + _normal;
};
export function lightblue(content) {
    return _lightblue + content + _normal;
};

export function grey(content) {
